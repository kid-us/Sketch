...
class LeftSideImgs extends Component {
    state = {
        modal: false,
        data: [],
        preview: ''
    ...
    render() {
        ...
        return (
            <>
                <div key={data.id} className={`${data.size === "" ? 'col-lg-6' : 'col-lg-8'} col-md-12`}>
                    {!data.process.img1
                        ?
                        <>
                ...
                <div className={`${data.size === '' ? 'col-lg-6' : 'col-lg-4'} col-12 px-4 fw-semibold small`}>
                    <h1 className="display-6 mt-4">{data.title}</h1>
